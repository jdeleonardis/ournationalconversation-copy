...
export class WriterDashboard extends Component {
  ...
  validation = () => {
    ...
    if (
      this.state.articleCategory === 'Opinion' &&
      this.state.newsTopic === ''
    ) {
    ...
    if (
      this.state.articleCategory === 'Opinion' &&
      this.state.newsTopic === 'Other' &&
      this.state.otherNewsTopic === ''
    ) {
    ...
    if (
      this.state.articleCategory === 'Solution' &&
      this.state.policyTopic === ''
    ) {
    ...
    if (
      this.state.articleCategory === 'Solution' &&
      this.state.policyTopic === 'Other' &&
      this.state.otherPolicyTopic === ''
    ) {
  ...
  addTag = (e) => {
    ...
    if (!this.validateNewTag()) {
      this.setState((prevState) => ({
        tagList: [...this.state.tagList, this.state.newTag],
        newTag: '',
      }));
    }
  };
  ...
  removeTag = (value, e) => {
    ...
    e.stopPropagation();
    this.setState({
      tagList: this.state.tagList.filter(function (tag) {
        return tag !== value;
      }),
    });
  };
                    ...
                    <Card.Body>
                      ...
                      <Form onSubmit={this.submitArticle}>
                        <Form.Group controlId='formBasicHeadline'>
                          <Form.Label className='sectionHeaders'>
                            HEADLINE
                          </Form.Label>
                          <Form.Control
                            type='text'
                          ...
                          <div
                            className={
                              ...
                              this.state.validationIssue.indexOf('headline') >=
                                0
                                ? ''
                                : 'height0 invisible'
                            }
                        ...
                        <Form.Group controlId='formBasicArticleSummary'>
                          ...
                          <div
                            className={
                              this.state.validationError &&
                              this.state.validationIssue.indexOf(
                                'articlesummary'
                              ) >= 0
                                ? ''
                                : 'height0 invisible'
                        ...
                        <Form.Group controlId='ckeditor'>
                          ...
                          <SunEditor
                            setOptions={{
                              defaultStyle:
                                'font-family: Roboto; font-size: 16px; font-weight: 400; line-height: 24px; color: #1E1E1E',
                              height: 300,
                              buttonList: [
                                ['undo', 'redo'],
                          ...
                          <div
                            className={
                              this.state.validationError &&
                              this.state.validationIssue.indexOf('article') >= 0
                                ? ''
                                : 'height0 invisible'
                            }
                          >
                          ...
                          <div
                            ...
                            style={{ fontSize: 'small' }}
                          >
                            DONT NEED!! PREVIEW IN RTE{' '}
                            <i id='fa-draft' className='fa fa-edit'></i>
                            <a href='Preview Draft'>
                              <u>Preview Draft</u>
                            </a>
                          </div>
                        </Form.Group>
